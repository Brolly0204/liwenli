...
function start() {
    ...
    lists[this.index + 1].style.display = "block", lists[this.index + 1].id = "a" + (this.index + 2), lists[this.index + 1].zIndex = 10, lists[this.index].style.webkitTransform = 0 === this.index % 2 ? "scale(0.5) translate(850px,-1500px)" : "scale(0.5) translate(-850px,-1500px)", lists[this.index].style.transition = 0 === this.index ? "all 1.7s linear 1s" : "all 2s linear"
}
